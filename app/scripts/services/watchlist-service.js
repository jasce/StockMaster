...
angular.module('stockMasterApp')
  .service('WatchlistService', function WatchlistService() {
    ...
    var loadModel = function () {
      var model = {
        watchlists: localStorage['StockMaster.watchlists'] ? JSON.parse(localStorage['StockMaster.watchlists']) : [],
        nextId: localStorage['StockMaster.nextId'] ? parseInt(localStorage['StockMaster.nextId']) : 0
      };
